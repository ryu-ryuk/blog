...
function updateIconClass(theme) {
    ...
    iconElement.classList.remove("catppuccin", "rose-pine", "system");

    // Add the appropriate class based on the selected theme
    if (theme === "catppuccin") {
        iconElement.classList.add("catppuccin");
    } else if (theme === "rose-pine") {
        iconElement.classList.add("rose-pine");
    } else if (theme === "system") {
        iconElement.classList.add("system");
    }
}
...
document.getElementById("theme-catppuccin").addEventListener("click", function () {
    switchTheme("catppuccin");
});
document.getElementById("theme-rose-pine").addEventListener("click", function () {
    switchTheme("rose-pine");
});
